...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.aiwerse.blog/ai/business-use-cases/${post.slug}`,
    },
    openGraph: {
      title: post.seoTitle || post.title,
      description: post.seoDescription || post.title,
      url: `https://www.aiwerse.blog/ai/business-use-cases/${post.slug}`,
      type: 'article',
    ...
    return (
      <main className="min-h-screen bg-white text-black flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/ai/business-use-cases" className="text-blue-600 hover:text-blue-700 font-semibold">
            Back to Business Use Cases
          </Link>
        </div>
      </main>
    )
