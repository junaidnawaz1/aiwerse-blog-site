...
import ShareButton from '@/components/ui/shareButton'; // Adjust the import path as needed
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.aiwerse.blog/ai-tools/${post.slug}`,
    },
    openGraph: {
      title: post.seoTitle || post.title,
      description: post.seoDescription || post.title,
      url: `https://www.aiwerse.blog/ai-tools/${post.slug}`,
      type: 'article',
...
export default async function Page({ params }) {
    ...
    return (
      <main className="min-h-screen bg-white text-black flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/ai-tools" className="text-blue-600 hover:text-blue-700 font-semibold">
            Back to AI Tools
          </Link>
        </div>
      </main>
  ...
  /* Blockquote: light bg, dark text (visible) */
